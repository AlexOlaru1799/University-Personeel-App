...
import mta.universitate.Model.Schedule;
...
public class Professor
{
    ...
    public String askForTeacherSalaryCertificate(/*int tipRaport, String data, int FK_User,int FK_Supervizor*/) throws SQLException {
        int tipRaport=4;
        String data="2021-12-04T10:00:00.000";
        int FK_User=1002;
    ...
    @GetMapping("/materiiProfesor")
    public String viewSubjects(/*String surname, String name*/) throws SQLException {

        String surname="Medvei";
        String name="Mirabela";

        Database db = Database.getInstance();
        ResultSet result = db.getSubjectsForTeacher(surname,name);
